...
borg_backup "${SERVER_DIR}" "${SERVER_LOCAL_BACKUP_DIR}" "${SERVER_BACKUP_KEEP_DAILY}" "${SERVER_BACKUP_KEEP_WEEKLY}" "${SERVER_BACKUP_KEEP_MONTHLY}" "${SERVER_EXCLUDE_REGEX[@]}"
...
borg_backup "${SERVER_DIR}" "${REMOTE_BACKUP_SERVER}:${SERVER_REMOTE_BACKUP_DIR}" "${SERVER_BACKUP_KEEP_DAILY}" "${SERVER_BACKUP_KEEP_WEEKLY}" "${SERVER_BACKUP_KEEP_MONTHLY}" "${SERVER_EXCLUDE_REGEX[@]}"
