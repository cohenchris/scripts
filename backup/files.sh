...
borg_backup ${FILES_DIR} ${FILES_LOCAL_BACKUP_DIR} ${FILES_EXCLUDE_REGEX[*]}
...
borg_backup ${FILES_DIR} ${REMOTE_BACKUP_SERVER}:${FILES_REMOTE_BACKUP_DIR} ${FILES_EXCLUDE_REGEX[*]}
